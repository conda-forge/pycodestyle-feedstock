...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pycodestyle-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pycodestyle-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pycodestyle
# for installing globally
pixi global install pycodestyle
```
...
It is possible to list all of the versions of `pycodestyle` available on your platform:
...
```
pixi search pycodestyle --channel conda-forge
```
